...
function CustomerList(props){
    ...
    return(
        <div className="container">
                ...
                <tbody>
                    {props.customers.map(cust=>{
                        return(<tr key={cust._id}>
                                    ...
                                    <td>{cust.email}</td>
                                    <td>{cust.mobile}</td>
                                    <td><a href={'/customers/'+cust._id}><button className="btn btn-info" onClick={()=>{}}>Show</button></a></td>
            ...
            <a href="/customers/new"><button className="btn btn-info" onClick={()=>{}}>Add Customer</button></a>
        </div>
    )
}
