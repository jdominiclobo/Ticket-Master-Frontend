    ...
    render(){
        return(<div>
                    <form onSubmit={this.handleSubmit} align='center'>
                        ...
                        <input type='email' placeholder='Email' name='email' value={this.state.email} onChange={this.handleChange} /><br/><br/>
                        <input type='mobile' placeholder='Mobile' name='mobile' value={this.state.mobile} onChange={this.handleChange} /><br/><br/>
