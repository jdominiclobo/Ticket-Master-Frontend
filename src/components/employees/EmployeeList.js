                ...
                <tbody>
                    {props.employees.map(emp=>{
                        return(<tr key={emp._id}>
                                    ...
                                    <td><a href={'/employees/'+emp._id}><button className="btn btn-info" onClick={()=>{}}>Show</button></a></td>
                                    <td><button className="btn btn-danger" onClick={()=>{handleRemove(emp._id)}}>Remove</button></td>
                              </tr>)
                                })}
                </tbody>
            </table>
            <a href="/employees/new"><button className="btn btn-info" onClick={()=>{}}>Add Employee</button></a>
        </div>
    )
}
