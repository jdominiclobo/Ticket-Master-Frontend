...
export const getDepartments = (departments) => {
    return {
        type : 'SET-DEPARTMENTS' , payload : departments
    }
}
...
export const addDepartments = (department) => {
    return {
        type : 'ADD-DEPARTMENT' , payload : department
    }
}
...
export const removeDepartment = (department)=>{
    return {
        type : 'REMOVE-DEPARTMENT', payload : department
    }
}
...
export const editDepartment = (department) => {
    return {
        type : 'EDIT-DEPARTMENT', payload : department 
    }
}
