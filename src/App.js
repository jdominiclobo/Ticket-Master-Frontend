          ...
          <nav className="mb-5 navbar navbar-expand-md navbar-light bg-light">
            ...
            <nav className="mb-5 navbar navbar-expand-md navbar-light bg-light">
              ...
              <ul className="ml-auto navbar-nav">
                ...
                <li className="nav-item">
                  <a className="nav-link text-primary" href="/customers">  Customers </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link text-primary" href="/departments">  Departments </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link text-primary" href="/employees"> Employees </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link text-primary" href="/tickets">  Tickets </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link text-primary" href="/account">  Account </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link text-primary" href="javascript:void()" onClick={handleClick}> Logout </a>
                </li>
              </ul>
            </nav>
          )
